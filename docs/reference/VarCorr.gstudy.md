...
method based on the backend used to fit the model.
...
For lme4 backend, returns a list of variance-covariance matrices for
each random effect term. For brms backend, returns a list with posterior
summaries.
